...
<div class="tag-card">
  <h4 class="tag-card-name">Past</h4>
  <ul class="tag-card-courses">
    <li><a class="tag-course-link" href="../../../all-training/old-course/">An old course</a></li>
  </ul>
</div>
</div>
