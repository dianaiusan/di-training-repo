...
Introductory tracks and skill progression tags.
...
<div class="tag-grid">
<div class="tag-card">
  <h4 class="tag-card-name">Advanced</h4>
...
<div class="tag-card">
  <h4 class="tag-card-name">Beginner</h4>
  <ul class="tag-card-courses">
    ...
    <li><a class="tag-course-link" href="../../../all-training/git-version-control/">Version Control and Reproducible Research with Git</a></li>
  </ul>
</div>
<div class="tag-card">
  <h4 class="tag-card-name">Intermediate</h4>
  <ul class="tag-card-courses">
    ...
    <li><a class="tag-course-link" href="../../../all-training/code-review-ci-hpc/">Code Review and CI on HPC</a></li>
