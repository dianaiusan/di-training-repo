...
# Copy this file to create new course/workshop pages in docs/all-training/events/
# The frontmatter fields below will be used by scripts to generate lists

title: "Course or Workshop Title"
slug: "course-slug" # Use the target course file name without .md in docs/all-training/events/
url: "/all-training/events/2026/course-slug/"
