...
url: "/all-training/events/2026/combined-python-intro-and-python-hpc/"
external_url: "https://www.hpc2n.umu.se/events/courses/2026/spring/Python-in-HPC"
...
short_description: "A brief, but comprehensive introduction to using Python in a Swedish academic High-Performance Computing (HPC) environment."
registration_url: "https://nextcloud.naiss.se/apps/forms/s/pr3eSLQkYC224ogZ2oFNnYX4"
...
The course is given under [NAISS](https://www.naiss.se/), by application experts from [UPPMAX](https://www.uu.se/centrum/uppmax/), [HPC2N](https://www.hpc2n.umu.se), [LUNARC](https://www.lunarc.lu.se/), [C3SE](https://www.c3se.chalmers.se/), and [InfraVis](https://infravis.se/).
...
This course will consist of lectures and follow-along exercises interspersed with hands-on sessions where you get to try out what you have just learned.
...
**Instructors:** Sahar Mahdie Klim al-Zaidawi, Richel Bilderbeek, Rebecca Pitts, Pedro Ojeda-May, Jayant Yadav, Björn Claremar, Birgitte Brydsö, Anders Hast.
