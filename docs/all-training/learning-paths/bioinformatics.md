...
!!! note
    This path currently has no mapped courses with canonical event pages.
    It will be repopulated as matching courses are published under `/all-training/events/2026/`.
