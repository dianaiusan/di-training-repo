...
- Shared stylesheet: docs/stylesheets/extra.css
...
1. Edit badge color rules in docs/stylesheets/extra.css.
2. Run zensical build.

### Add or change category assignment for tags

1. Update TAG_TO_CATEGORY in scripts/generate_tags.py.
2. Ensure matching badge class exists in docs/stylesheets/extra.css.
...
2. Add a badge class in docs/stylesheets/extra.css.
